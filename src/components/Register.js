...
const Register = () => {
    ...
    const handlesubmit = (e) => {
            e.preventDefault();
            let regobj = { firstname, lastname, password, email, role: "user", phoneNumber};
            if (IsValidate()) {
            //console.log(regobj);
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        ...
                                        <input value={phoneNumber} onChange={e => phoneNumberchange(e.target.value)} className="form-control"></input>
                                    </div>
                                </div>
                            </div>
